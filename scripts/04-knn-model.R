...
knn_tuning_plot <- tune_results |>
  ...
  labs(
    title = "knn multi-parameter tuning",
...
pred_dist_plot <- results |>
  ...
  labs(
    title = "prediction distribution (confidence)",
...
ggsave("plots/knn-model/knn_tuning_plot.png", plot = knn_tuning_plot, width = 10, height = 8)
ggsave("plots/knn-model/confusion_matrix.png", plot = cm_plot, width = 6, height = 5)
ggsave("plots/knn-model/prediction_distribution.png", plot = pred_dist_plot, width = 8, height = 6)
