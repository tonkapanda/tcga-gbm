...
write_csv(final_train, "data/processed/lasso_1se_train_data.csv")
write_csv(final_test, "data/processed/lasso_1se_test_data.csv")

print(paste("lasso has selected", length(selected_genes), "genes."))


ggsave("plots/feature-selection/lasso_tuning_plot_1se.png",
       plot = tuning_plot, width = 8, height = 6
)

ggsave("plots/feature-selection/lasso_coefs_1se.png",
